    ...
    <section className="relative z-10 py-20">
      <div className="container-xl px-6">
        ...
        <div className="relative w-full" style={{ height: "160px" }}>
          ...
          {/* HTML circles — always perfect, solid color fill */}
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  />
                  <p className="text-[9px] font-black uppercase tracking-[0.4em] mb-1" style={{ color }}>
                    Step {num}
                  </p>
            ...
            <motion.div style={{ y: heroY, opacity: heroOpacity }} className="max-w-5xl">
              <div className="flex items-center gap-3 mb-8">
                ...
                <motion.span
                  ...
                  className="text-[10px] font-black uppercase tracking-[0.5em] text-cyan-400"
                >
                  SaaS Development
                </motion.span>
              </div>
        ...
        <section className="relative z-10 pb-20">
          <div className="container-xl px-6">
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              {/* Feature list — original left-side box style */}
              <div className="space-y-4 order-2 lg:order-1">
                {features.map((item, i) => (
                  ...
                  >
                    <div className="w-12 h-12 rounded-2xl bg-white/[0.03] border border-white/10 flex items-center
                                    justify-center shrink-0 group-hover:scale-110 group-hover:border-cyan-500/50
              ...
              {/* Parallax image — original effect */}
              <ParallaxImagePanel />
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            >
              <motion.div
                ...
                className="absolute top-0 left-0 w-72 h-[2px] bg-gradient-to-r from-transparent via-cyan-500 to-transparent"
              />
              <motion.div
                animate={{ x: ["200%", "-100%"] }}
                transition={{ duration: 3.5, repeat: Infinity, ease: "linear", delay: 1.75 }}
                className="absolute bottom-0 right-0 w-72 h-[2px] bg-gradient-to-r from-transparent via-fuchsia-500 to-transparent"
              />
