    ...
    <>
      ...
      <main className="bg-[#020205] text-white pt-40 pb-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          ...
          />
          <div className="absolute top-0 right-0 w-full h-[800px] bg-fuchsia-500/10 blur-[160px]" />
          <div className="absolute bottom-0 left-1/4 w-[600px] h-[600px] bg-cyan-500/5 blur-[140px]" />
        </div>
        ...
        <div className="container-xl relative z-10 px-6">
          ...
          >
            <motion.div 
              initial={{ width: 0 }}
              animate={{ width: "160px" }}
              className="h-px bg-fuchsia-500/50 mb-10"
            />
             ...
             <div className="relative aspect-square lg:order-2">
                ...
                >
                   ...
                   <motion.div 
                      ...
                      className="absolute inset-x-0 h-1/2 bg-gradient-to-b from-fuchsia-400/0 via-fuchsia-400/10 to-transparent opacity-0 group-hover:opacity-100"
                   />
             ...
             <div className="max-w-6xl mx-auto px-4">
                ...
                >
                   ...
                   <motion.div 
                      ...
                      className="absolute top-0 left-0 w-80 h-[2px] bg-gradient-to-r from-transparent via-fuchsia-500 to-transparent" 
                   />
                   ...
                   <Link href="/contact?service=landing" className="px-14 py-6 rounded-full bg-white text-black font-black uppercase tracking-[0.2em] text-sm transition-all hover:bg-fuchsia-600 hover:text-white hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(255,255,255,0.1)] inline-flex items-center gap-3">
