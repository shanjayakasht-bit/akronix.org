...
const DEFAULT_SERVICES: ServiceItem[] = [
  {
    ...
    shortDesc: "Scalable SaaS solutions built for growth.",
    description: "End-to-end SaaS development from architecture to deployment. We build multi-tenant, scalable, and secure software products.",
  ...
  },
  {
    ...
    shortDesc: "Launch fast, validate early, scale later.",
    description: "Rapidly build and launch your minimum viable product. We help startups get to market quickly with the right features.",
  ...
  },
  {
    ...
    shortDesc: "Data-driven growth for your brand.",
    description: "Full-service digital marketing including SEO, performance marketing, and social media management.",
  ...
  },
  {
    name: "AI & Automation",
    slug: "ai-automation",
    shortDesc: "Smart solutions powered by AI.",
    description: "Integrate AI and automation into your workflows to increase efficiency, reduce costs and make smarter decisions.",
